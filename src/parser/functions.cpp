...
// Table 3.1 and 3.2 in Wannier 90 user guide 
    ...
    if (s == "py"){pfv->push_back(func_info(1,1)); return 0;}
    if (s == "pz"){pfv->push_back(func_info(1,2)); return 0;}
    if (s == "px"){pfv->push_back(func_info(1,3)); return 0;}
    ...
    if (s == "dxy"   ){pfv->push_back(func_info(2,1)); return 0;}
    if (s == "dyz"   ){pfv->push_back(func_info(2,2)); return 0;}
    if (s == "dz2"   ){pfv->push_back(func_info(2,3)); return 0;}
    if (s == "dxz"   ){pfv->push_back(func_info(2,4)); return 0;}
    if (s == "dx2-y2"){pfv->push_back(func_info(2,5)); return 0;}
    ...
    if (s == "fy(3x2-y2)"){pfv->push_back(func_info(3,1)); return 0;}
    if (s == "fxyz"      ){pfv->push_back(func_info(3,2)); return 0;}
    if (s == "fyz2"      ){pfv->push_back(func_info(3,3)); return 0;}
    if (s == "fz3"       ){pfv->push_back(func_info(3,4)); return 0;}
    if (s == "fxz2"      ){pfv->push_back(func_info(3,5)); return 0;}
    if (s == "fz(x2-y2)" ){pfv->push_back(func_info(3,6)); return 0;}
    if (s == "fx(x2-3y2)"){pfv->push_back(func_info(3,7)); return 0;}
